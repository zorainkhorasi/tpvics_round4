        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Monitoring Report </h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?php base_url() ?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Monitoring Report
                                </li>
                            </ol>
                        </div>
                    </div>
...
<script>
    ...
    $('#partner').change(function () {
        ...
        $.post('<?php echo base_url() . 'index.php/Monitoring_report/getFilters'  ?>', { Partner: partner }, function (res) {
    ...
    $('#province').change(function () {
        ...
        $.post('<?php echo base_url() . 'index.php/Monitoring_report/getFilters'  ?>', filters, function (res) {
    ...
    function loadData() {
        ...
        $('#dataTable').DataTable({
           ...
           // pageLength: 100, // default
            ...
            ajax: {
                url: '<?php echo base_url() . 'index.php/Monitoring_report/getData'  ?>',
                type: 'POST',
                data: filters
            },
