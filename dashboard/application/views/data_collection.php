                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Interview Status</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-end">
                                ...
                                <img src="<?php echo base_url() ?>assets/images/<?php echo $country_id ?>.gif" height="24" alt="Country Flag">
                            </div>
                                ...
                                <div class="card-body completed_clusters">
                                    ...
                                    if (isset($totalcluster['list']) && $totalcluster['list'] != '') {
                                        ...
                                        foreach ($totalcluster['list'] as $k => $t_list) {
                                            ...
                                            ?>
                                            <a href="<?php echo base_url('index.php/Data_collection/dashboard_dt/'.$t_list['district_id'].'/t/'.$country_id) ?>">
                                    ...
                                    <?php if (isset($completed) && $completed != '') {
                                        ...
                                        foreach ($completed as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('index.php/Data_collection/dashboard_dt/'.$id.'/c/'.$country_id) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                    ...
                                    <?php if (isset($ip) && $ip != '') {
                                        ...
                                        foreach ($ip as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Data_collection/dashboard_dt/'.$id.'/i/'.$country_id) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?></p>
                                                        </div>
                                    ...
                                    <?php if (isset($r) && $r != '') {
                                        ...
                                        foreach ($r as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Data_collection/dashboard_dt/'.$id.'/r/'.$country_id) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?></p>
                                                        </div>
