        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Cluster Profile Report </h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?php base_url() ?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Cluster Profile Report
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cluster Profile Report </h4>
                            </div>
...
<script>
    ...
    $('#partner').change(function () {
        ...
        $.post('<?php echo base_url() . 'index.php/Cluster_Profile_report/getFilters'  ?>', { Partner: partner }, function (res) {
    ...
    $('#province').change(function () {
        ...
        $.post('<?php echo base_url() . 'index.php/Cluster_Profile_report/getFilters'  ?>', filters, function (res) {
    ...
    function loadData() {
        ...
        $('#dataTable').DataTable({
           ...
           // pageLength: 100, // default
            ...
            ajax: {
                url: '<?php echo base_url() . 'index.php/Cluster_Profile_report/getData'  ?>',
                type: 'POST',
                data: filters
            },
