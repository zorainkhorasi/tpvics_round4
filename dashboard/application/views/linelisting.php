                                ...
                                <div class="card-body completed_clusters">
                                    ...
                                    if (isset($totalcluster['list']) && $totalcluster['list'] != '') {
                                        ...
                                        foreach ($totalcluster['list'] as $k => $t_list) {
                                            ...
                                            ?>
                                            <a href="<?php echo base_url('index.php/Listing/dashboard_dt/'.$t_list['district_id'].'/t/'.$country_id) ?>">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between pb-0">
                                <h4 class="card-title">Randomized Clusters</h4>
                                <img src="<?php echo base_url() ?>assets/images/<?php echo $country_id ?>.gif" height="24" alt="Country Flag">
                            </div>
                            <div class="card-content">
                                <div class="card-body py-0">
                                    ...
                                    <?php if (isset($completed) && $completed != '') {
                                        ...
                                        foreach ($completed as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                ?>
                                                <a href="<?php echo base_url('index.php/Listing/dashboard_dt/'.$id.'/c/'.$country_id) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                    ...
                                    <?php if (isset($r) && $r != '') {
                                        ...
                                        foreach ($r as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Listing/dashboard_dt/'.$id.'/r/'.$country_id) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?></p>
                                                        </div>
