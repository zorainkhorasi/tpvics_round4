    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Children Anthro Status</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?php base_url() ?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Anthro Status</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="content-body">
            ...
            <?php if (isset($slug_district) && $slug_district != '' && $slug_district != 0) {
                ...
                echo '<input type="hidden" id="two_hidden" value="' . $anthro_cnt . '">';
                ...
                <section id="column-selectors">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Camp Children Anthro Summary</h4>
                                </div>
                                <div class="card-content">
                                                ...
                                                if (isset($myData) && $myData != '') {
                                                    foreach ($myData as $k => $r) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $r->u5 ?></td>
                                                            <td><?php echo $r->weightTotal ?></td>
                                                            <td><?php echo $r->heightTotal ?></td>
                                                            <td><?php echo $r->muac ?></td>
                                                        </tr>
                                                    <?php }
                                                } ?>
                                                </tbody>
    ...
    function searchData() {
        ...
        if (district == '' || district == undefined || district == '0' || district == '$1') {
            ...
            if (ucs == '' || ucs == undefined || ucs == '0' || ucs == '$1') {
                ...
                window.location.href = '<?php echo base_url() ?>index.php/Camp_CM/Camp_status/status_children_anthro?t=c&uc=' + ucs + '&a=' + area;
            }
