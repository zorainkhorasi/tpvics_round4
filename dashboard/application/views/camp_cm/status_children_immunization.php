        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Children Immunized Status</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?php base_url() ?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Immunized Status</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <section id="column-selectors">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Camp Children Immunized Summary</h4>
                                </div>
                                <div class="card-content">
    ...
    function searchData() {
        ...
        if (district == '' || district == undefined || district == '0' || district == '$1') {
            ...
            if (ucs == '' || ucs == undefined || ucs == '0' || ucs == '$1') {
                ...
                window.location.href = '<?php echo base_url() ?>index.php/Camp_CM/Camp_status/status_children_immunization?t=c&uc=' + ucs + '&a=' + area;
            }
