...
class Monitoring_progress_Model extends CI_Model
{
    public function getDistinct($column, $where = [])
    {
        ...
        return $this->db->get('monitoring_progress')->result_array();
    }

    public function getColumns()
    {
        return $this->db->list_fields('monitoring_progress');
    }

    public function getData($filters)
    {
        $this->db->from('monitoring_progress');
