...
class Cluster_Wise_Progress_Model extends CI_Model
{
    public function getDistinct($column, $where = [])
    {
        ...
        return $this->db->get('Cluster_Wise_Progress')->result_array();
    }

    public function getColumns()
    {
        return $this->db->list_fields('Cluster_Wise_Progress');
    }

    public function getData($filters)
    {
        $this->db->from('Cluster_Wise_Progress');
