...
class Cluster_Profile_Model extends CI_Model
{
    public function getDistinct($column, $where = [])
    {
        ...
        return $this->db->get('Cluster_Profile')->result_array();
    }

    public function getColumns()
    {
        return $this->db->list_fields('Cluster_Profile');
    }

    public function getData($filters)
    {
        $this->db->from('Cluster_Profile');
