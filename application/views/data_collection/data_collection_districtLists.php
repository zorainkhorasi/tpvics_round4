                                ...
                                <div class="card-body completed_clusters">
                                    ...
                                    if (isset($totalcluster['list']) && $totalcluster['list'] != '') {
                                        ...
                                        foreach ($totalcluster['list'] as $k => $t_list) {
                                            ...
                                            ?>
                                            <a href="<?php echo base_url('index.php/Data_collection_progress/dc_dt/d' . substr($t_list['id'], 0, 1) . '_t/s' . $t_list['id'] . '_t') ?>">
                                    ...
                                    <?php if (isset($completed) && $completed != '') {
                                        ...
                                        foreach ($completed as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Data_collection_progress/dc_dt/d' . substr($id, 0, 1) . '_c/s' . $id . '_c') ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?>  </p>
                                                        </div>
                                    ...
                                    <?php if (isset($r) && $r != '') {
                                        ...
                                        foreach ($r as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Data_collection_progress/dc_dt/d' . substr($id, 0, 1) . '_i/s' . $id . '_i') ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?></p>
                                                        </div>
