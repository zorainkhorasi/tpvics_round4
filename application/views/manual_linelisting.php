    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="container-fluid form-container my-5">
                ...
                <input type="hidden" id="hidden_slug_uc"
                       value="<?php echo(isset($slug_uc) && $slug_uc != '' ? $slug_uc : ''); ?>">
                ...
                <div class="row mb-3 ">
                    <div class="col-md-3 d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <select class="form-control form-control-plaintext select2 district_select"
                                    autocomplete="uc"
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="text" class="form-control form-control-plaintext village"
                                               id="village" required>
                                    </div>
                                </div>
                                <div class="col-md-4 d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="text" class="form-control form-control-plaintext hf" id="hf"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-4 d-flex align-items-center">
                        ...
                        <div class="col-md-4">
                            <div class="detail-box">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="text"
                                               class="form-control form-control-plaintext name_of_vaccinator"
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="date"
                                               class="form-control form-control-plaintext vaccinator_visit_date"
                        ...
                        <div class="col-md-4">
                            <div class="detail-box">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="date" class="form-control form-control-plaintext lhw_visit_date"
                        ...
                        <div class="col-md-4">
                            <div class="detail-box">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        <input type="date" class="form-control form-control-plaintext polio_visit_date"
