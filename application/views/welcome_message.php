                    ...
                    <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                        <div class="card-content ">
                            <div class="card-body text-center white">
                                ...
                                <p class="p-2">
                                    Dashboard - SHRUC Health Camps
                                </p>
                                <a class="btn btn-info btn-lg mt-2 waves-effect waves-light"
                                   href="<?php echo base_url('index.php/dashboard/linelisting_dashboard') ?>">
                                    LineListing
                                </a>
                                <a class="btn btn-danger btn-lg mt-2 waves-effect waves-light"
                                   href="<?php echo base_url('index.php/data_collection_progress') ?>">
                                    Data Collection
                                </a>
                                <a class="btn btn-warning btn-lg mt-2 waves-effect waves-light"
                                   href="<?php echo base_url('index.php/image_forms') ?>">
