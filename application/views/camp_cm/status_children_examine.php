    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Children Examine Status</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="<?php base_url() ?>">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Examine Status</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="content-body">
            ...
            <?php if (isset($slug_district) && $slug_district != '' && $slug_district != 0) {
                ...
                echo '<input type="hidden" id="two_hidden" value="' . $examine_cnt . '">';
            ...
            <?php if (isset($children_top_deseases) && $children_top_deseases != '' && $children_top_deseases != 0) {
                $disease_array=array();
                foreach ($children_top_deseases[0] as $cd_key => $cd_val) {
                    $disease_array[$cd_key]=$cd_val;
                }
                arsort($disease_array);
                foreach ($disease_array as $cd_key => $cd_val) {
                    echo '<input type="hidden" class="child_desease" name="child_desease' . $cd_key . '" id="child_desease' . $cd_key . '" 
                ...
                <section id="column-selectors">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Camp Children Examine Summary</h4>
                                </div>
                                <div class="card-content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped dataex-html5-selectors">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="5%">Diarrhea</th>
                                                    <th width="5%">Cough & Cold</th>
                                                    <th width="5%">Pneumonia</th>
                                                    <th width="5%">Severe Pneumonia</th>
                                                    <th width="5%">Asthma</th>
                                                    <th width="5%">Worm Infestation</th>
                                                    <th width="5%">Skin ailment</th>
                                                    <th width="5%">Eye Infection</th>
                                                    <th width="5%">Ear Infection</th>
                                                    <th width="5%">Malaria</th>
                                                    <th width="5%">Typhoid</th>
                                                    <th width="5%">Tonsillitis</th>
                                                    <th width="5%">Measles</th>
                                                    <th width="5%">Pulmonary TB</th>
                                                    <th width="5%">Sepsis</th>
                                                    <th width="5%">Anemia</th>
                                                    <th width="5%">Other</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                if (isset($myData) && $myData != '') {
                                                    foreach ($myData as $k => $r) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $r->u5 ?></td>
                                                            <td><?php echo $r->Diarrhea ?></td>
                                                            <td><?php echo $r->Cough ?></td>
                                                            <td><?php echo $r->Pneumonia ?></td>
                                                            <td><?php echo $r->Severe_Pneumonia ?></td>
                                                            <td><?php echo $r->Asthma ?></td>
                                                            <td><?php echo $r->Worm_Infestation ?></td>
                                                            <td><?php echo $r->Skin_Ailment ?></td>
                                                            <td><?php echo $r->Eye_Infection ?></td>
                                                            <td><?php echo $r->Ear_Infection ?></td>
                                                            <td><?php echo $r->Malaria ?></td>
                                                            <td><?php echo $r->Typhoid ?></td>
                                                            <td><?php echo $r->Tonsillitis ?></td>
                                                            <td><?php echo $r->Measles ?></td>
                                                            <td><?php echo $r->Pulmonary_TB ?></td>
                                                            <td><?php echo $r->Sepsos ?></td>
                                                            <td><?php echo $r->Anemia ?></td>
...
<script>
    $(document).ready(function () {
        ...
        var mydata = [];
        var mylabel = [];
        var child_desease = $('.child_desease');
        $.each(child_desease, function (i, v) {
        ...
        var barChartOptions = {
            ...
            yaxis: {
                title: {
                    text: 'Diagnosis in Children (For Under Five years)',
                },
            }
        };
    ...
    function searchData() {
        ...
        if (district == '' || district == undefined || district == '0' || district == '$1') {
            ...
            if (ucs == '' || ucs == undefined || ucs == '0' || ucs == '$1') {
                ...
                window.location.href = '<?php echo base_url() ?>index.php/Camp_CM/Camp_status/status_children_examine?t=c&uc=' + ucs + '&a=' + area;
            }
