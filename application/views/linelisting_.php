                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2 col-12 d-flex flex-column flex-wrap text-center">
                                            <h1 class="font-large-2 text-bold-700 mt-2 mb-0"><?php
                                                if (!isset($cluster_type) || $cluster_type == '') {
                                                    $t_cluster_url = 'o';
                                                    $c_cluster_url = 'o';
                                                    $ip_cluster_url = 'o';
                                                    $r_cluster_url = 'o';
                                ...
                                <div class="card-body completed_clusters">
                                    <!--                                <ul class="list-group list-group-flush customer-info totalClustersList">-->
                                    ...
                                    if (isset($totalcluster['list']) && $totalcluster['list'] != '') {
                                        foreach ($totalcluster['list'] as $k => $t_list) {
                                            /* echo ' <li class="list-group-item d-flex justify-content-between">
                                                     ...
                                                     <a href="' . base_url('index.php/Dashboard/index/d' . $t_list['id'] . '_t') . '">
                                                         <i class="fa fa-circle font-small-3 text-' . $colors[$k] . '"></i>
                                                         <span class="text-bold-600 total_name">' . ucfirst($t_list['district']) . '</span> </a>
                                                     </div>
                                                     <div class="product-result">
                                                         <span class="total_val">' . $t_list['clusters_by_district'] . '</span>
                                                     </div>

                                                 </li>';*/ ?>
                                            <a href="<?php echo base_url('index.php/Dashboard/index/d' . $t_list['id'] . '_' . $t_cluster_url) ?>">
                                            ...
                                            <div class="progress progress-bar-<?php echo $colors[$k] ?> mb-2">
                                    ...
                                    <?php if (isset($completed) && $completed != '') {
                                        ...
                                        foreach ($completed as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Dashboard/index/d' . $id . '_' . $c_cluster_url) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                    ...
                                    <?php if (isset($ip) && $ip != '') {
                                        ...
                                        foreach ($ip as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Dashboard/index/d' . $id . '_' . $ip_cluster_url) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?></p>
                                                        </div>
                                    ...
                                    <?php if (isset($r) && $r != '') {
                                        ...
                                        foreach ($r as $k => $d) {
                                            if ($k != 'total') {
                                                ...
                                                $perc = ($d / $t) * 100;
                                                ?>
                                                <a href="<?php echo base_url('index.php/Dashboard/index/d' . $id . '_' . $r_cluster_url) ?>">
                                                    <div class="d-flex justify-content-between mb-25">
                                                        <div class="browser-info">
                                                            <p class="mb-25"><?php echo $k; ?></p>
                                                        </div>
